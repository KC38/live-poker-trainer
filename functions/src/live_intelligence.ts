...
function coachSystemPrompt(): string {
  return [
    ...
    "position, actions, and legal sizings are authoritative; do not",
    "recalculate or contradict them. Equity is an estimate against modeled",
    "ranges, never the opponents' actual cards.",
