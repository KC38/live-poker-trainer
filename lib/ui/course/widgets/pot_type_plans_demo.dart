...
/// Limped / SRP / 3-4bet tiles for pot-type plans explain demos.
...
class _PotTypePlansDemoState extends State<PotTypePlansDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    // sparse green under LIMPED / SRP / 3-4BET).
    final feltHeight =
          ...
          Expanded(
            child: _PotTypePlansSoftPulse(
              ...
              child: _PotTypePlansTile(
                ...
                densify: expandTeach,
                selected: _tapped.contains(PotTypePlansDemo.points[i].label),
...
class _PotTypePlansSoftPulse extends StatefulWidget {
  const _PotTypePlansSoftPulse({required this.active, required this.child});

  final bool active;
  final Widget child;

  @override
  State<_PotTypePlansSoftPulse> createState() => _PotTypePlansSoftPulseState();
}

class _PotTypePlansSoftPulseState extends State<_PotTypePlansSoftPulse>
  ...
  @override
  void didUpdateWidget(covariant _PotTypePlansSoftPulse oldWidget) {
