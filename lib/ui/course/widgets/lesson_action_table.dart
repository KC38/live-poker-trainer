...
/// Explain-step demo: pre-deal table read (pot, stacks, button, who acts).
class TableReadDemo extends StatefulWidget {
  ...
  static const points = <({String label, String caption, Color color})>[
    (label: 'POT', caption: 'Size it', color: AppColors.cream),
    (label: 'STACKS', caption: 'Depths', color: AppColors.gold),
    (label: 'BUTTON', caption: 'Who deals', color: AppColors.slate),
    (label: 'ACTS', caption: "Who's first", color: AppColors.danger),
  ];
    ...
    final child = Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            widget.interactive
                ? 'Tap Pot, Stacks, Button, and Acts'
