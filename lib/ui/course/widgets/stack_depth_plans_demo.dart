...
class _StackSoftPulse extends StatefulWidget {
  const _StackSoftPulse({required this.active, required this.child});

  final bool active;
  final Widget child;

  @override
  State<_StackSoftPulse> createState() => _StackSoftPulseState();
}

class _StackSoftPulseState extends State<_StackSoftPulse>
  ...
  @override
  void didUpdateWidget(covariant _StackSoftPulse oldWidget) {
