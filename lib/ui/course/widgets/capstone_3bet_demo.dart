...
class _Capstone3betSoftPulse extends StatefulWidget {
  const _Capstone3betSoftPulse({required this.active, required this.child});

  final bool active;
  final Widget child;

  @override
  State<_Capstone3betSoftPulse> createState() => _Capstone3betSoftPulseState();
}

class _Capstone3betSoftPulseState extends State<_Capstone3betSoftPulse>
  ...
  @override
  void didUpdateWidget(covariant _Capstone3betSoftPulse oldWidget) {
