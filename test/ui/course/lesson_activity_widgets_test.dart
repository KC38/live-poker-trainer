...
void main() {
  ...
  testWidgets(
    'turn-plan explain taps Brick Change Barrel Delay instead of Continue',
    (tester) async {
    final activity = CourseActivity(
      id: 'act-03-05-01-explain',
      order: 1,
    ...
    expect(find.byType(TurnPlanDemo), findsOneWidget);
    expect(find.text('Tap Brick, Change, Barrel, and Delay.'), findsOneWidget);
    expect(resolveCoachDialogueVisual(activity).requiresFeltTap, isTrue);
    expect(isTableRegionTapActivity(activity), isTrue);
