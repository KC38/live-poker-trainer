...
class _SameCardsTypesDemoState extends State<SameCardsTypesDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    // sparse green under CARDS / MODELS / CITE).
    final feltHeight =
    ...
    final tiles = Row(
      ...
      children: [
        for (var i = 0; i < SameCardsTypesDemo.points.length; i++) ...[
          ...
          Expanded(
            child: _SameCardsTypesSoftPulse(
              active:
                  widget.interactive &&
                  widget.enabled &&
              ...
              child: _SameCardsTypesTile(
                ...
                densify: expandTeach,
                selected: _tapped.contains(SameCardsTypesDemo.points[i].label),
...
class _SameCardsTypesSoftPulse extends StatefulWidget {
  const _SameCardsTypesSoftPulse({required this.active, required this.child});

  final bool active;
  final Widget child;

  @override
  State<_SameCardsTypesSoftPulse> createState() => _SameCardsTypesSoftPulseState();
}

class _SameCardsTypesSoftPulseState extends State<_SameCardsTypesSoftPulse>
  ...
  @override
  void didUpdateWidget(covariant _SameCardsTypesSoftPulse oldWidget) {
