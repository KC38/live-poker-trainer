...
class HuVsMultiwayDemo extends StatefulWidget {
  ...
  static const points = <({String label, String caption, Color color})>[
    (label: 'FEWER', caption: 'Bluff less MW', color: AppColors.slate),
    (label: 'THICKER', caption: 'Value up MW', color: AppColors.gold),
    (label: 'WIDEN', caption: 'HU selected bluffs', color: AppColors.cream),
  ];

  @override
  State<HuVsMultiwayDemo> createState() => _HuVsMultiwayDemoState();
}

class _HuVsMultiwayDemoState extends State<HuVsMultiwayDemo> {
  ...
  ({String label, String caption, Color color})? get _nextPoint {
    for (final point in HuVsMultiwayDemo.points) {
  ...
  Widget build(BuildContext context) {
    ...
    // sparse green under FEWER / THICKER / WIDEN).
    final feltHeight =
          ...
          Expanded(
            child: _HuVsMultiwaySoftPulse(
              active:
                  widget.interactive &&
                  widget.enabled &&
                  next?.label == HuVsMultiwayDemo.points[i].label,
              child: _HuVsMultiwayTile(
                ...
                densify: expandTeach,
                selected: _tapped.contains(HuVsMultiwayDemo.points[i].label),
                enabled: widget.interactive && widget.enabled,
                onPressed: widget.interactive
                    ? () => _onTap(HuVsMultiwayDemo.points[i].label)
                    : null,
              ),
            ),
          ),
...
class _HuVsMultiwayTile extends StatelessWidget {
  const _HuVsMultiwayTile({
    required this.label,
...
class _HuVsMultiwaySoftPulse extends StatefulWidget {
  const _HuVsMultiwaySoftPulse({required this.active, required this.child});

  final bool active;
  final Widget child;

  @override
  State<_HuVsMultiwaySoftPulse> createState() => _HuVsMultiwaySoftPulseState();
}

class _HuVsMultiwaySoftPulseState extends State<_HuVsMultiwaySoftPulse>
  ...
  @override
  void didUpdateWidget(covariant _HuVsMultiwaySoftPulse oldWidget) {
