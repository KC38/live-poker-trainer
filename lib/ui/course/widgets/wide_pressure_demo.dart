...
class _WidePressureDemoState extends State<WidePressureDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    // sparse green under WIDE / PRESSURE / SAMPLE).
    final feltHeight =
          ...
          Expanded(
            child: _WidePressureSoftPulse(
              ...
              child: _WidePressureTile(
                ...
                densify: expandTeach,
                selected: _tapped.contains(WidePressureDemo.points[i].label),
...
class _WidePressureSoftPulse extends StatefulWidget {
  const _WidePressureSoftPulse({required this.active, required this.child});

  final bool active;
  final Widget child;

  @override
  State<_WidePressureSoftPulse> createState() => _WidePressureSoftPulseState();
}

class _WidePressureSoftPulseState extends State<_WidePressureSoftPulse>
  ...
  @override
  void didUpdateWidget(covariant _WidePressureSoftPulse oldWidget) {
