...
class _TypeBoardLineDemoState extends State<TypeBoardLineDemo> {
  ...
  ({String label, String caption, Color color})? get _nextPoint {
    for (final point in TypeBoardLineDemo.points) {
  ...
  Widget build(BuildContext context) {
    ...
    // sparse green under TYPE / BOARD / LINE / SIZE).
    final feltHeight =
          ...
          Expanded(
            child: _TypeBoardLineSoftPulse(
              active:
                  widget.interactive &&
                  widget.enabled &&
                  next?.label == TypeBoardLineDemo.points[i].label,
              child: _TypeBoardLineTile(
                ...
                densify: expandTeach,
                selected: _tapped.contains(TypeBoardLineDemo.points[i].label),
...
class _TypeBoardLineSoftPulse extends StatefulWidget {
  const _TypeBoardLineSoftPulse({required this.active, required this.child});

  final bool active;
  final Widget child;

  @override
  State<_TypeBoardLineSoftPulse> createState() => _TypeBoardLineSoftPulseState();
}

class _TypeBoardLineSoftPulseState extends State<_TypeBoardLineSoftPulse>
  ...
  @override
  void didUpdateWidget(covariant _TypeBoardLineSoftPulse oldWidget) {
