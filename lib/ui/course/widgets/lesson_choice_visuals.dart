...
SelectIdentifyPresentation resolveSelectIdentifyPresentation(
  ...
  if (activity.id == 'act-02-02-01-scaffolded-broadway') {
  ...
  if (activity.id == 'act-03-02-01-unguided') {
  ...
  if (activity.id == 'act-04-10-02-jump-spr') {
    // S4 jump SPR: tap 4 / 2 / 8 on densified stack÷pot felt (no type-in).
    return SelectIdentifyPresentation.tableRegionTap;
  }
  ...
  if (activity.id == 'act-06-13-01-checkpoint') {
  ...
  if (activity.id == 'act-07-04-01-guided' ||
