...
void main() {
  ...
  test('resolveCoachDialogueVisual is content-driven', () {
    ...
    // Passive "fold"/"value" without river must not steal river-plan.
    expect(
      resolveCoachDialogueVisual(
        CourseActivity(
  ...
  testWidgets(
    'river-plan explain taps Value Bluff Catch Fold instead of Continue',
    (tester) async {
    final activity = CourseActivity(
      id: 'act-03-06-01-explain',
      order: 1,
    ...
    expect(find.byType(RiverPlanDemo), findsOneWidget);
